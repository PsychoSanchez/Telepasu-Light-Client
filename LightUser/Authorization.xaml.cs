...
namespace LightUser
{
    public partial class Authorization : Window
    {
        ...
        //        {
        //            BMessageBox.Show("Отменено пользователем");
        //        }
        //        return;
        //    }
        //    int result;
        ...
        //            try
        //            {
        //                EventLogs.WriteLog("Начинаем вход");
        //                ///Использование мд5 шифрования
        //                if (MD5Authorization)
        //                {
        //                    var login = false;
        //                    EventLogs.WriteLog("Используем MD5");
        //                    try
        //                    {
        //                        login = loginAmiManager.ConnectMD5(loginTextbox.Text, passTextbox.Text, ipserverTextbox.Text, Int32.Parse(portTextbox.Text));
        //                    }
        //                    catch (Exception ex)
        //                    {
        //                        EventLogs.WriteLog(ex.Message, ex.StackTrace);
        //                    }
        //                    EventLogs.WriteLog("Авторизация: ", login.ToString());
        //                    ///Если подключение прошло успешно, то сохраняем настройки иначе выводим ошибку
        //                    if (login)
        //                    {
        //                        EventLogs.WriteLog("Удачный вход с MD5");
        //                        bLoginSuccess = true;
        //                        reconCounter = 3;
        //                        if (loginAmiManager.Initialize(set.Number))
        //                        {
        //                            EventLogs.WriteLog("Успешная инициализация MD5");
        //                            StatusLabel.BeginInvoke(
        //                                (MethodInvoker)(() =>
        //                                {
        //                                    try
        //                                    {
        //                                        EventLogs.WriteLog("Изменяем статулейбл на Успешный вход");
        ...
        //                        else
        //                        {
        //                            EventLogs.WriteLog("Неуспешная инициализация MD5");
        //                            StatusLabel.BeginInvoke(
        //                                    (MethodInvoker)(() =>
        //                                    {
        //                                        try
        //                                        {
        //                                            EventLogs.WriteLog("Изменяем статуслейбл на Ошибка при инициализации");
        ...
        //                        }
        //                        e.Cancel = true;
        //                        EventLogs.WriteLog("Сохранение настроек подключения");
        //                        set.SaveSettings();
        //                    }
        //                    else
        //                    {
        //                        EventLogs.WriteLog("Неудачное подключение");
        //                        if (!bw.CancellationPending)
        //                        {
        //                            EventLogs.WriteLog("Отказано сервером MD5");
        ...
        //                        }
        //                        e.Cancel = true;
        //                        EventLogs.WriteLog("Сохранение настроек");
        //                        set.SaveSettings();
        //                    }
        //                    else
        //                    {
        //                        if (!bw.CancellationPending)
        //                        {
        //                            EventLogs.WriteLog("Отказано сервером");
        //                            StatusLabel.BeginInvoke(
        //                                (MethodInvoker)(() =>
        //                                {
        //                                    try
        ...
        //                        else
        //                        {
        //                            EventLogs.WriteLog("Отменено пользователем");
        //                            StatusLabel.BeginInvoke((MethodInvoker)(() => StatusLabel.Text = "Отменено пользователем"));
        //                            loginAmiManager.Abort();
        //                            reconCounter = 0;
        //                            e.Cancel = true;
        ...
        //            {
        //                EventLogs.WriteLog("Истёк срок ожидания");
